...
function construirEncabezadoPlan(planPrincipal) {
  ...
  // materia" y "Editar plan" se mudaron a la barra de acciones (ver
...
function construirBarraAcciones() {
  ...
  // Aquí, donde antes vivía ese botón, ahora va "Editar plan" (antes vivía
  // en el encabezado) y, SOLO mientras el modo edición está activo,
  // "+ Añadir materia" aparece justo al lado — con el mismo color
  // (btn-secondary los dos) y exactamente el mismo ancho (igualarAnchoBotones
  // mide el más ancho de los dos tras el layout real y fuerza ese mismo
  // ancho en ambos; ver más abajo).
 ...
 * tras requestAnimationFrame). Se usa para "Editar plan" + "Añadir materia"
